$(document).ready(function(){
  ...
  $('#start').click(function(){
    command.empty();
    textblock.hide();
    textblock.append('<p>it has started snowing</p><p>you can see the flurries outside your living room window</p><p>strange things have been happening since winter started</p><p>people going missing and disturbing noises in the night</p>');
    command.append('<button class="btn move">go to window?</button> <button class="btn stay">stay put</button>');
    textblock.fadeIn(900, 'linear');
    ...
    $('.move').click(function(){
      ...
      $('.stay').click(function(){
        ...
        command.append('<button class="move btn">fetch your shotgun</button><button class="stay btn">remain by the window</button>');
        //DECISION 2A
        $('.move').click(function(){
          clear();
